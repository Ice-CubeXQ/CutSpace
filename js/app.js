(() => {
  ...
  const _ = {
    ...
    updateSlides: function () {
      ...
      const i = e.params,
        ...
        p = S(n, `.${e.params.slideClass}, swiper-slide`),
      ...
      for (let r = 0; r < u; r += 1) {
        ...
        if (
          ...
          if ("auto" === i.slidesPerView) {
            ...
            (A = (a - (i.slidesPerView - 1) * x) / i.slidesPerView),
              i.roundLengths && (A = Math.floor(A)),
    ...
    updateSlidesClasses: function () {
      const e = this,
        ...
        a = (e) => S(i, `.${s.slideClass}${e}, swiper-slide${e}`)[0];
      let o;
      if (
        (t.forEach((e) => {
          e.classList.remove(
      ...
      if (
        ...
        if (0 === t) o[e ? "scrollLeft" : "scrollTop"] = -c;
          ...
          if (!n.support.smoothScroll)
            return (
              w({ swiper: n, targetPosition: -c, side: e ? "left" : "top" }), !0
            );
    ...
    slideTo: function (e = 0, t = this.params.speed, s = !0, i, r) {
      ...
      if (o.cssMode) {
        ...
        if (0 === t) {
          ...
          if (!n.support.smoothScroll)
            return (
              w({ swiper: n, targetPosition: s, side: e ? "left" : "top" }), !0
            );
  ...
  function V(e) {
    ...
    c.matches(r.focusableElements) &&
      ((b = !1), "SELECT" === c.nodeName && (r.isTouched = !1)),
      s.activeElement &&
  ...
  function N(e) {
    ...
    const p = i.evCache.length > 1 ? i.evCache[0] : l,
      u = p.pageX,
      m = p.pageY;
    if (l.preventedByNestedSwiper) return (n.startX = u), void (n.startY = m);
    if (!s.allowTouchMove)
      return (
  ...
  function F(e) {
    ...
    for (
      ...
      void 0 !== o[e + t]
        ? m >= o[e] && m < o[e + t] && ((f = e), (v = o[e + t] - o[e]))
        : m >= o[e] && ((f = e), (v = o[o.length - 1] - o[o.length - 2]));
    }
    let g = null,
      w = null;
    r.rewind &&
      (t.isBeginning
        ...
        : t.isEnd && (g = 0));
    const S = (m - o[f]) / v,
      T = f < r.slidesPerGroupSkip - 1 ? 1 : r.slidesPerGroup;
    if (p > r.longSwipesMs) {
      if (!r.longSwipes) return void t.slideTo(t.activeIndex);
      "next" === t.swipeDirection &&
        (S >= r.longSwipesRatio
          ? t.slideTo(r.rewind && t.isEnd ? g : f + T)
          : t.slideTo(f)),
      ...
      events: {
        attachEvents: function () {
          ...
          (e.onTouchStart = V.bind(e)),
            ...
            (e.onClick = H.bind(e)),
            (e.onLoad = W.bind(e)),
            q || (t.addEventListener("touchstart", R), (q = !0)),
            X(e, "on");
        },
  ...
  class Z {
    ...
    getSlideIndex(e) {
      const { slidesEl: t, params: s } = this,
        i = b(S(t, `.${s.slideClass}, swiper-slide`)[0]);
      return b(e) - i;
    }
  ...
  window.addEventListener("load", function (e) {
    te(),
      document.querySelector(".provide__slider") &&
        new ee(".provide__slider", {
          observer: !0,
          observeParents: !0,
          slidesPerView: "auto",
          spaceBetween: 32,
